...
const columns: ColumnDef<AttendanceData>[] = [
...

  {
    ...
    cell: ({ row }) => (
      <div className="text-gray-700 text-[.9em] text-center font-Poppins flex items-center gap-1">
        <span className="font-barlow">{row.getValue("dept")}</span>
      </div>
    ),
  },

  {
    ...
    cell: ({ row }) => (
      <div className="text-gray-700 text-[.9em] text-center font-Poppins flex items-center gap-1">
        <span className="font-barlow">{row.getValue("course")}</span>
      </div>
    ),
  },
  ...
  //   cell: ({ row }) => (
  //     <div className="text-gray-700 text-[.9em] text-center font-Poppins flex items-center gap-1">
  //       <span className="font-barlow">{row.getValue("attendance")}</span>
  //     </div>
  //   ),
  // },

  {
    ...
    cell: ({ row }) => {
      let textColor = "";
      let bgColor = "";
      switch (row.getValue("attendance")) {
        case "P":
