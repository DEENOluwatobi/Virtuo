...
const columns: ColumnDef<StaffData>[] = [
...

  {
    ...
    cell: ({ row }) => {
      return (
        <div className={`w-full flex items-center justify-center rounded-xl p-2 bg-purple-100`}>
          <span className={`font-Poppins font-medium text-[.9em] text-[#1671D9]`}>
            {row.getValue("type")}
          </span>
        </div>
      );
...

  {
    ...
    cell: ({ row }) => (
      <div className="text-gray-700 text-[.9em] text-center font-Poppins flex items-center gap-1">
        <span className="font-barlow">{row.getValue("gender")}</span>
      </div>
    ),
  },
...

  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center">
        <span className="text-gray-600 text-[.9em] cursor-pointer">
          {row.original.course.join(', ')}
        </span>
      </div>
    ),
  },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-white w-full px-4 py-2 flex flex-col gap-2 shadow-md shadow-gray-300 rounded-[10px]">
            ...
            <DropdownMenuItem className="w-full cursor-pointer flex gap-4 items-center">
              <div className="rounded-full w-10 h-10 flex justify-center items-center bg-orange-100">
                <AddCircleOutlineIcon className="text-orange-400"/>
              </div>
              <div className="text-[.9em] text-gray-700 flex flex-col">
                <span className="text-[1.1em] font-semibold">Assign</span>
                <span className="font-light">Assign a class/course</span>
              </div>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="w-full cursor-pointer flex gap-4 items-center">
              ...
              <div className="text-[.9em] text-gray-700 flex flex-col">
                ...
                <span className="font-light">Send a mail message to a Lecturer/Teacher</span>
              </div>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="w-full cursor-pointer flex gap-4 items-center">
              ...
              <div className="text-[.9em] text-gray-700 flex flex-col">
                ...
                <span className="font-light">Suspend this Lecturer/Teacher</span>
              </div>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="w-full cursor-pointer flex gap-4 items-center">
              ...
              <div className="text-[.9em] text-gray-700 flex flex-col">
                ...
                <span className="font-light">Delete this Lecturer/Teacher</span>
              </div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
