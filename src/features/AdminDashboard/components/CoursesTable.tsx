...
const columns: ColumnDef<CoursesData>[] = [
  {
    accessorKey: "course",
    header: () => (
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-2">
        ...
        <div className='flex flex-col justify-center'>
          <span className='font-Poppins text-[1em] font-semibold text-gray-700'>{row.getValue("course")}</span>
          <span className='font-Poppins text-[.9em] text-gray-500'>{row.original.code}</span>
        </div>
      </div>
    )
  },
...

  {
    ...
    cell: ({ row }) => (
      <div className="text-gray-700 text-[.9em] text-center font-Poppins flex items-center gap-1">
        <span className="font-barlow">{row.getValue("faculty")}</span>
      </div>
    ),
  },

  {
    ...
    cell: ({ row }) => (
      <div className="text-gray-700 text-[.9em] text-center font-Poppins flex items-center gap-1">
        <span className="font-barlow">{row.getValue("unit")}</span>
      </div>
    ),
  },
