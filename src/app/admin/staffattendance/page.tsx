...
import StaffAttendance from '@app/features/AdminDashboard/components/StaffAttendance'
            ...
            <div className='w-full flex flex-col gap-4'>
              <div className='flex justify-between items-center'>
                <div className='w-full flex flex-col'>
                  <h1 className='text-black text-[1em] font-medium'>Staff Attendance</h1>
                  <p className='text-[#475367] text-[.8em]'>Staff Performance</p>
                </div>
